...
Python was used as the primary programming language for data preprocessing, model development, evaluation, and visualization.Sklearn was the main machine learning framework used for data processing, model training and model evaluation. Pandas was used for data manipulation and preprocessing while Numpy was used for numerical computations and array operations.
## Installations
...
Banks can use the model to assess whether an applicant is likely to repay the loan.The model can help determine appropriate interest rate based on a customer’s predicted risk level. Customer segmentation-Organizations can group customers according to risk profiles and help organizations in improving operational efficiency and data-driven assessments
